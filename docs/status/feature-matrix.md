...
| ------------------------------------------------ | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| SEAM contract (`music_seam`)                     | ✅      | Artifact tables, descriptors, opcode families, and structural validation exist; `data.new` uses `type_len`, `data.get/data.set` exist, and `hdl.push` takes an effect id (handler object is a stack value) |
| SEAM text transport (`music_seam`)               | ✅      | Text format, parser, formatter, and validation exist                                                                                                                                                       |
| SEAM binary transport (`music_seam`)             | ✅      | Binary encode/decode and validation exist                                                                                                                                                                  |
