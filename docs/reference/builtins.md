...
- Filesystem, process, random, datetime, formatting primitives, and target facts use focused host/VM primitive modules. Stdlib algorithms stay in `@std/*` Musi source whenever the language can express them.
