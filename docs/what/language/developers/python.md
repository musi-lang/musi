...
{{snippet:guide-python-developers}}

Python developers often bring dynamic scripts, dictionaries, list work, and exceptions.
Musi keeps the useful part of that experience, but the code shape changes: Use records for small named shapes, data definitions for variants, and effects for boundary work.
