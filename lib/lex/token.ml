module Token = struct
  ...
  let show = function
    ...
    | ( DotDotLt | DotDot | LtMinus | ColonEq | Eq | BangEq | Lt | LtEq | Gt
      | GtEq | LtLt | GtGt | Plus | Minus | Star | Slash | StarStar | PipeGt
      | Amp | Pipe | Caret | Tilde | At | Bang | LParen | RParen | LBrace
      | RBrace | LBrack | RBrack | Comma | Semi | Colon | Dot | MinusGt | EqGt
      | Underscore | Question ) as sym ->
  ...
  let is_operator = function
    | DotDotLt | DotDot | LtMinus | ColonEq | Eq | BangEq | Lt | LtEq | Gt
    | GtEq | Plus | Minus | Star | Slash | StarStar | PipeGt | LtLt | GtGt | Amp
    | Pipe | Caret | Tilde | At | Bang ->
      true
    | _ -> false
