...
let suite =
  ...
  ; ("numbers_errors_incomplete_hex", `Quick, test_numbers_errors_incomplete_hex)
  ...
  ; ("unicode_escape_missing_brace", `Quick, test_unicode_escape_missing_brace)
  ...
  ; ("template_extra_closing_brace", `Quick, test_template_extra_closing_brace)
