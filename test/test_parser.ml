...
let test_parser_state () =
  ...
  (check string) "peek token" "LitNumber" (Token.to_string token)
...
let () =
  ...
  run
    "Parser Unit Tests"
    [
      ("parser_state", [ test_case "parser state" `Quick test_parser_state ])
    ; ( "literals"
      , [
          test_case "number" `Quick test_expr_lit_number
        ; test_case "string" `Quick test_expr_lit_string
        ; test_case "rune" `Quick test_expr_lit_rune
        ] )
    ; ("identifiers", [ test_case "identifier" `Quick test_expr_ident ])
    ; ("templates", [ test_case "template" `Quick test_expr_template ])
    ; ("tuples", [ test_case "tuple" `Quick test_expr_tuple ])
    ; ("blocks", [ test_case "block" `Quick test_expr_block ])
    ; ( "control_flow"
      , [
          test_case "if" `Quick test_expr_if
        ; test_case "if_else" `Quick test_expr_if_else
    ...
    ; ( "statements"
      , [
        ...
        ; test_case "break_value" `Quick test_expr_break_value
        ; test_case "cycle" `Quick test_expr_cycle
        ; test_case "unsafe" `Quick test_expr_unsafe
        ] )
    ; ("assignments", [ test_case "assignment" `Quick test_expr_assign ])
    ; ( "binary_ops"
      , [
          test_case "add" `Quick test_expr_binary_add
        ; test_case "mul" `Quick test_expr_binary_mul
        ] )
    ; ( "unary_ops"
      , [
          test_case "neg" `Quick test_expr_unary_neg
        ; test_case "not" `Quick test_expr_unary_not
        ] )
    ; ( "calls_and_access"
      , [
    ...
    ; ( "records"
      , [
          test_case "record_lit" `Quick test_expr_record_lit
        ; test_case "record_lit_named" `Quick test_expr_record_lit_named
        ] )
    ; ( "functions"
      , [
          test_case "fn" `Quick test_expr_fn
        ; test_case "fn_named" `Quick test_expr_fn_named
        ] )
    ; ( "types"
      , [
          test_case "record" `Quick test_expr_record
        ; test_case "choice" `Quick test_expr_choice
        ; test_case "trait" `Quick test_expr_trait
        ] )
    ; ( "patterns"
      , [
          test_case "bind" `Quick test_pat_bind
        ; test_case "bind_var" `Quick test_pat_bind_var
        ; test_case "lit_number" `Quick test_pat_lit_number
        ; test_case "lit_string" `Quick test_pat_lit_string
        ; test_case "wild" `Quick test_pat_wild
        ; test_case "ident" `Quick test_pat_ident
        ; test_case "record" `Quick test_pat_record
        ; test_case "ctor" `Quick test_pat_ctor
        ; test_case "tuple" `Quick test_pat_tuple
        ] )
    ; ( "types"
      , [
          test_case "ptr" `Quick test_typ_ptr
        ; test_case "arr" `Quick test_typ_arr
        ; test_case "slice" `Quick test_typ_slice
        ; test_case "ident" `Quick test_typ_ident
        ; test_case "app" `Quick test_typ_app
        ; test_case "tuple" `Quick test_typ_tuple
        ; test_case "fn" `Quick test_typ_fn
        ; test_case "record" `Quick test_typ_record
        ; test_case "optional" `Quick test_typ_optional
        ] )
    ; ( "imports"
      , [
          test_case "named" `Quick test_stmt_import_named
        ; test_case "all" `Quick test_stmt_import_all
        ] )
    ; ( "exports"
      , [
          test_case "named" `Quick test_stmt_export_named
        ; test_case "all" `Quick test_stmt_export_all
        ] )
    ; ( "bindings"
      , [
          test_case "val" `Quick test_stmt_bind_val
        ; test_case "var" `Quick test_stmt_bind_var
        ; test_case "typed" `Quick test_stmt_bind_typed
        ] )
    ; ( "externs"
      , [
          test_case "extern" `Quick test_stmt_extern
        ; test_case "extern_abi" `Quick test_stmt_extern_abi
        ] )
    ; ("expr_statements", [ test_case "expr" `Quick test_stmt_expr ])
    ; ( "programs"
      , [
          test_case "empty" `Quick test_program_empty
        ; test_case "single_stmt" `Quick test_program_single_stmt
        ; test_case "multi_stmt" `Quick test_program_multi_stmt
        ] )
    ]
