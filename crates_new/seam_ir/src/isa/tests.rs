...
use super::{ALL_OPCODES, Instruction, Opcode, OpcodeFamily, Operand};

#[test]
fn opcode_inventory_has_unique_bytes() {
...
#[test]
fn opcode_round_trips_by_mnemonic() {
...
#[test]
fn opcode_families_match_runtime_domains() {
...
#[test]
fn removed_opcodes_are_not_decodable() {
    for mnemonic in [
        "ld.nil",
        "ld.one",
        "br.back",
...
#[test]
fn instruction_builders_store_expected_operands() {
