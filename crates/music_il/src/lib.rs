...
pub use descriptors::{
    ...
    EffectOpDescriptor, EffectOps, FIRST_EMITTED_TYPE_ID, FfiType, ForeignAbi, ForeignDescriptor,
    ForeignParamTypes, MethodNames, NAN_BOX_BOOL, NAN_BOX_CHAR, NAN_BOX_PTR, NAN_BOX_SMI,
    NAN_BOX_TAG, NAN_BOX_UNIT, TypeDescriptor, TypeKind,
};
