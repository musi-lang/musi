...
fn mnemonic_returns_correct_string() {
    ...
    assert_eq!(Opcode::LdCst.mnemonic(), "ld.cst");
    assert_eq!(Opcode::LdGlb.mnemonic(), "ld.glb");
    assert_eq!(Opcode::LdUpv.mnemonic(), "ld.upv");
    assert_eq!(Opcode::LdUnit.mnemonic(), "ld.unit");
    assert_eq!(Opcode::LdTrue.mnemonic(), "ld.true");
    assert_eq!(Opcode::LdFalse.mnemonic(), "ld.false");
    assert_eq!(Opcode::LdZero.mnemonic(), "ld.zero");
    assert_eq!(Opcode::LdOne.mnemonic(), "ld.one");
    assert_eq!(Opcode::LdSmi.mnemonic(), "ld.smi");
    assert_eq!(Opcode::StLoc.mnemonic(), "st.loc");
    assert_eq!(Opcode::StGlb.mnemonic(), "st.glb");
    ...
    assert_eq!(Opcode::IMod.mnemonic(), "i.mod");
    ...
    assert_eq!(Opcode::ClsUpv.mnemonic(), "cls.upv");
    ...
    assert_eq!(Opcode::ArrConcat.mnemonic(), "arr.concat");
    assert_eq!(Opcode::ArrGeti.mnemonic(), "arr.geti");
    assert_eq!(Opcode::ArrSeti.mnemonic(), "arr.seti");
    assert_eq!(Opcode::ArrTag.mnemonic(), "arr.tag");
    assert_eq!(Opcode::ArrNewt.mnemonic(), "arr.newt");
    ...
    assert_eq!(Opcode::EffResume.mnemonic(), "eff.resume");
    assert_eq!(Opcode::ClsDict.mnemonic(), "cls.dict");
    assert_eq!(Opcode::ClsCall.mnemonic(), "cls.call");
