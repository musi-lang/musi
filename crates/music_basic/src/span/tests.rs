...
#[test]
fn test_new_sets_start_and_end() {
...
#[test]
fn test_len_returns_difference() {
    assert_eq!(Span::new(3, 8).len(), 5);
}

#[test]
fn test_len_of_empty_is_zero() {
...
#[test]
fn test_to_creates_span_from_start_to_end() {
    let a = Span::new(3, 7);
...
#[test]
fn test_spanned_inequality_on_different_kind() {
...
#[test]
fn test_spanned_hash_ignores_span() {
    let a = Spanned::new(42, Span::new(0, 5));
...
#[test]
fn test_spanned_map_transforms_kind() {
