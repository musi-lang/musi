...
use music_ast::TyIdx;
use music_ast::expr::{
    Arg, ArrayElem, BinOp, BindKind, Expr, FieldKey, HandlerOp, LetFields, Param, RecField,
    UnaryOp,
};
...
fn emit_unary(
    ...
    match op {
        ...
        UnaryOp::Do => unreachable!("handled before emit_unary is called"),
    }
}
