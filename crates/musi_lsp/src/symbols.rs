...
use musi_ast::{AstArena, ChoiceCase, ExprId, ExprKind, FnSig, PatKind, Prog, StmtKind};
use musi_core::{Interner, Name, SourceFile, Span};
...
impl SymbolCollector<'_> {
    ...
    fn resolve_name(&self, sym: Name) -> String {
        self.interner.resolve(sym.id).to_owned()
    }
