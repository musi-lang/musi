...
impl AstArena {
    ...
    pub fn alloc_stmt(&mut self, kind: StmtKind, span: Span) -> StmtId {
        ...
        self.stmts.alloc(Stmt::new(id, kind, span));
        id
    }
}
