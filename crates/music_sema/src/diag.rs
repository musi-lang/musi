...
pub enum SemaDiagKind {
    ...
    AttrMusiLangRequiresFoundationModule,
    AttrMusiLangRequiresExport,
    AttrMusiLangUnknownName,
    AttrMusiIntrinsicRequiresOpcodeString,
    AttrMusiIntrinsicRequiresFoundationModule,
...
const SEMA_DIAG_INFOS: &[SemaDiagInfo] = &[
    ...
    SemaDiagInfo {
        kind: SemaDiagKind::AttrMusiLangRequiresFoundationModule,
        code: 3010,
        message: "`@musi.lang` requires `musi:*` module",
    },
    SemaDiagInfo {
        kind: SemaDiagKind::AttrMusiLangRequiresExport,
        code: 3011,
        message: "`@musi.lang` requires exported binding",
    },
    SemaDiagInfo {
        kind: SemaDiagKind::AttrMusiLangUnknownName,
        code: 3012,
        message: "`@musi.lang` name is unknown",
    },
    SemaDiagInfo {
    ...
    SemaDiagInfo {
        kind: SemaDiagKind::AttrMusiIntrinsicRequiresFoundationModule,
        code: 3014,
        message: "`@musi.intrinsic` requires `musi:*` module",
    },
    SemaDiagInfo {
