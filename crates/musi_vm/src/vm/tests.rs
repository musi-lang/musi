    ...
    let bytes = make_msbc_with_effects(
        ...
        &[
            ...
            fn_def(
                ...
                0,
                0,
                vec![Opcode::CNT_SAV.0, 1, 0, 0, 0, Opcode::RET.0],
            ),
            fn_def(
                2,
                0,
    ...
    let bytes = make_msbc(
        ...
        &[
            fn_def(
                ...
                0,
                vec![
                    Opcode::MK_CLO.0, 0x00, 0x01, 0x00, 0x00,
                    Opcode::INV_DYN.0, 0,
                    Opcode::RET.0,
                ],
            ),
...
fn test_st_fld() {
    ...
    let bytes = make_msbc(
        &[ConstEntry::I32(10), ConstEntry::I32(20), ConstEntry::I32(99)],
        &[fn_def(
            0,
            1,
            0,
    ...
    let bytes = make_msbc(
        ...
        &[
            fn_def(
                ...
                vec![
                    Opcode::LD_LOC.0, 0,
                    Opcode::MK_CLO.0, 0x01, 0x01, 0x00, 0x00,
                    Opcode::INV_DYN.0, 0,
                    Opcode::RET.0,
                ],
            ),
