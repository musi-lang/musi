...
export const siteCopy: Record<Locale, LocalizedSiteCopy> = {
	en: {
		...
		learn: {
			...
			title: "Musi book",
			description:
				"Read Musi in chapter order or jump in by task. Learning pages stay close to install steps and current commands.",
			startTitle: "Start with setup and keep moving",
			questionsTitle: "Use common questions",
	...
	ja: {
		...
		learn: {
			...
			title: "Musi ブック",
			description:
				"章順に読み進めることも、タスクから入ることもできます。学習内容は導入手順と現在のコマンドの近くに置いています。",
			startTitle: "セットアップから順に進む",
			questionsTitle: "よくある質問から入る",
			partsTitle: "パートと章",
		},
	},
};
