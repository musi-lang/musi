...
const rawBookPages = [
...

	{
		...
		partId: "developers",
		path: "/docs/book/developers/python",
		aliases: [
			"/docs/language/developers/python",
			"/learn/language/developers/python",
		],
		sourcePath: "docs/what/language/developers/python.md",
		questions: [],
	},
	{
		id: "musi-for-java-developers",
		partId: "developers",
		path: "/docs/book/developers/java",
		aliases: [
			"/docs/language/developers/java",
			"/learn/language/developers/java",
		],
		sourcePath: "docs/what/language/developers/java.md",
		questions: [],
	},
	{
		id: "musi-for-javascript-developers",
		partId: "developers",
		path: "/docs/book/developers/javascript",
		aliases: [
			"/docs/language/developers/javascript",
			"/learn/language/developers/javascript",
		],
		sourcePath: "docs/what/language/developers/javascript.md",
		questions: [],
	},
	{
		id: "musi-for-typescript-developers",
		partId: "developers",
		path: "/docs/book/developers/typescript",
		aliases: [
			"/docs/language/developers/typescript",
			"/learn/language/developers/typescript",
		],
		sourcePath: "docs/what/language/developers/typescript.md",
		questions: [],
	},
	{
		id: "musi-for-c-developers",
		partId: "developers",
		path: "/docs/book/developers/c",
		aliases: ["/docs/language/developers/c", "/learn/language/developers/c"],
		sourcePath: "docs/what/language/developers/c.md",
		questions: [],
	},
	{
		id: "musi-for-cpp-developers",
		partId: "developers",
		path: "/docs/book/developers/cpp",
		aliases: [
			"/docs/language/developers/cpp",
			"/learn/language/developers/cpp",
		],
		sourcePath: "docs/what/language/developers/cpp.md",
		questions: [],
	},
	{
		id: "musi-for-csharp-developers",
		partId: "developers",
		path: "/docs/book/developers/csharp",
		aliases: [
			"/docs/language/developers/csharp",
			"/learn/language/developers/csharp",
		],
		sourcePath: "docs/what/language/developers/csharp.md",
		questions: [],
	},
	{
		id: "musi-for-go-developers",
		partId: "developers",
		path: "/docs/book/developers/go",
		aliases: ["/docs/language/developers/go", "/learn/language/developers/go"],
		sourcePath: "docs/what/language/developers/go.md",
		questions: [],
	},
	{
