...
This part gives you first working model of the language: files read top to bottom, `let` names values, blocks produce results, and mutation is explicit instead of ambient.
