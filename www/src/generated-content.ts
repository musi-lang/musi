...
export const renderedDocs = [
	...
	},
	{
		...
		"headings": [],
		"html": "<p>A handler interprets requested operations. It decides what a request means at a particular boundary.</p>\n<div class=\"snippet-block\"><section class=\"code-panel\"><pre class=\"shiki shiki-themes github-light-high-contrast github-dark\" style=\"background-color:#ffffff;--shiki-dark-bg:#24292e;color:#0e1116;--shiki-dark:#e1e4e8\" tabindex=\"0\"><code><span class=\"line\"><span style=\"color:#A0111F;--shiki-dark:#F97583\">handle</span><span style=\"color:#0E1116;--shiki-dark:#E1E4E8\"> console.</span><span style=\"color:#622CBC;--shiki-dark:#B392F0\">readln</span><span style=\"color:#0E1116;--shiki-dark:#E1E4E8\">() </span><span style=\"color:#A0111F;--shiki-dark:#F97583\">using</span><span style=\"color:#0E1116;--shiki-dark:#E1E4E8\"> console {</span></span>\n<span class=\"line\"><span style=\"color:#0E1116;--shiki-dark:#E1E4E8\">  value </span><span style=\"color:#A0111F;--shiki-dark:#F97583\">=></span><span style=\"color:#0E1116;--shiki-dark:#E1E4E8\"> value;</span></span>\n<span class=\"line\"><span style=\"color:#622CBC;--shiki-dark:#B392F0\">  readln</span><span style=\"color:#0E1116;--shiki-dark:#E1E4E8\">(k) </span><span style=\"color:#A0111F;--shiki-dark:#F97583\">=></span><span style=\"color:#A0111F;--shiki-dark:#F97583\"> resume</span><span style=\"color:#032563;--shiki-dark:#9ECBFF\"> \"ok\"</span><span style=\"color:#0E1116;--shiki-dark:#E1E4E8\">;</span></span>\n<span class=\"line\"><span style=\"color:#0E1116;--shiki-dark:#E1E4E8\">};</span></span></code></pre></section></div><p>Read <code>handle console.readln() using console { ... }</code> as running an expression while interpreting console requests with this handler. <code>value =&gt; value;</code> covers normal completion. <code>readln(k) =&gt; resume &quot;ok&quot;;</code> answers one requested operation and continues the suspended computation.</p>\n<p>A handler is a local policy desk: request asks for help; handler says what help means here.</p>\n<p>Continue to <a href=\"/learn/book/effects-runtime/runtime-model/foundation\">Foundation</a>.</p>\n",
