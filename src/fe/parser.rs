...
//     errors::{MusiError, MusiResult, SyntaxErrorKind},
//     span::Span,
...
//                 return Err(MusiError::Syntax(SyntaxErrorKind {
...
//                         Ok(Value::Real(n))
//                     } else {
//                         Err(MusiError::Syntax(SyntaxErrorKind {
//                             message: "number literal out of range",
//                         }))
//                     }
//                 })
//                 .map_err(|_| {
//                     MusiError::Syntax(SyntaxErrorKind {
...
//             Ok(self.advance())
//         } else {
//             Err(MusiError::Syntax(SyntaxErrorKind { message }))
//         }
//     }
// }
